...
KERN_IO_OBJ := io/router.o io/device.o io/filesystem.o io/message.o io/middleware.o io/mount.o ioapi/file.o iopath/libpath.o
...
PROG_OBJ := $(KERN_OBJ) $(KERN_IO_OBJ) $(BASELINE_OBJ)
